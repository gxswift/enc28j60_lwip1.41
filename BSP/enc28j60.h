...
#define ENC28J60_CS_L		GPIO_ResetBits(GPIOG,GPIO_Pin_8)
#define ENC28J60_RST_L	GPIO_ResetBits(GPIOG,GPIO_Pin_6)
#define ENC28J60_CS_H		GPIO_SetBits(GPIOG,GPIO_Pin_8)
#define ENC28J60_RST_H	GPIO_SetBits(GPIOG,GPIO_Pin_6)
